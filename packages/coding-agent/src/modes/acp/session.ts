...
import { type PiRpcEvent, PiRpcProcess, PiRpcSpawnError } from "./pi-rpc-inprocess.ts";
...
export class PiAcpSession {
	...
	// biome-ignore lint/correctness/noUnusedPrivateClassMembers: agent-loop flag assigned across the turn lifecycle; retained for parity with upstream pi-acp.
